...
const Dashboard = () => {
  ...
  return (
    <div className="flex-1 container mx-auto p-4 max-h-[calc(100vh-72px)] overflow-hidden">
      <div className="grid grid-cols-12 gap-4 h-full">
        {/* Main Content */}
        <div className="col-span-12 lg:col-span-8 space-y-4 overflow-y-auto pb-4">
        ...
        <div className="col-span-12 lg:col-span-4 space-y-4 overflow-y-auto pb-4">
